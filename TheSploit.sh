...
clear
echo
echo $red"          Again install the tools, please wait for the next 12 hours"
echo $red"            It takes time to install, please wait"   
sleep 1
echo '''\a
\033[34;1m                                           ,----------------,              ,---------,    
\033[34;1m                                      ,-----------------------,          ,"        ,"|
...
\033[34;1m                                   +  .-----------------.  +  +     +---------+      +
\033[34;1m                                   +  +                 +  +  +     + -==----'+      +
\033[34;1m                                   +  +  FROM ASCI Art! +  +  +     +         +      +
\033[34;1m                                   +  +  DESIGN BY KRIS +  +  +/----+`---=    +      +
\033[34;1m                                   +  +  C:\>_<         +  +  +   ,/+#### ooo +      ;
\033[34;1m                                   +  +    081316577616 +  +  +  // +(((( [33]+    ,"
\033[34;1m                                   +  `-----------------'  +," .;'+ +((((     +  ,"
\033[34;1m                                   +-----------------------+  ;;  + +         +,"     -OYE-
\033[34;1m                                      /_)______________(_/  //'   + +---------+
\033[34;1m                                 ___________________________/___  `,
\033[34;1m                                /  oooooooooooooooo  .o.  oooo /,   \,"-----------
\033[34;1m                               / ==ooooooooooooooo==.o.  ooo= //   ,`\--{)B     ,"
\033[34;1m                              /_==__==========__==_ooo__ooo=_/'   /___________,"
\033[34;1m                              `-----------------------------'
sleep 1
...
sleep 1
echo '''\a
\033[32;1m                             ________________________________________________    
\033[32;1m                            /                                                \           
\033[32;1m                           +    _________________________________________     +         
\033[32;1m                           +   +                                         +    +        
\033[32;1m                           +   +  C:\> _                                 +    +          
\033[32;1m                           +   +  git clone https://github.com/TheSploit +    +
\033[32;1m                           +   +  My-Tools                               +    +
\033[32;1m                           +   +  cd My-Tools                            +    +
\033[32;1m                           +   +  sh TheSploit.sh                        +    +
\033[32;1m                           +   +                                         +    +
\033[32;1m                           +   +    Username:-----                       +    +
\033[32;1m                           +   +    Password:-----                       +    +
\033[32;1m                           +   +                                         +    + 
\033[32;1m                           +   +                SUCCES ACCESS            +    +
\033[32;1m                           +   +            -------------------------    +    +
\033[32;1m                           +   +           -------- Wait for Confirm     +    +
\033[32;1m                           +   +_________________________________________+    +
\033[32;1m                           +                                                  +
\033[32;1m                            \_________________________________________________/
\033[32;1m                                   \___________________________________/
sleep 1
apt install php
...
echo
echo
echo $red"         Patience Boss still has 98 Numbers Before Going to Menu"
echo $red"            The more Gans the faster enter the menu"
sleep 1
echo '''\a
\033[35;1m                                 _SPLO_                      
\033[35;1m                                THESPLOIT     ,"""""""""""""".
\033[35;1m                               @p~qp~~qMb    + THE SPLOIT!  +
\033[35;1m                               M|@||@) M|   _;..............'
\033[35;1m                               @,----.JM| -'
\033[35;1m                               JS^\__/  qKL
\033[35;1m                             SPL        OIT1
...
echo
echo
echo $red"         Patience Ya Zheyenkk Remaining hm ... 100 Deh it is true"
echo $red"            Btw If you are a girl please call: 081316577616"
sleep 1
echo '''\a
\033[33;1m                                             ,        ,                
\033[33;1m                                            /(        )`
...
\033[33;1m            +  + +\  + ~+~ \ /             `.___/`    /
\033[33;1m            +  + + \ +  +   X                `-----' /
\033[33;1m            `__+ +  \+ _+_ / \  <----.     __ / __   \
\033[33;1m                                <----|----O)))--) \) /----
\033[33;1m                                <----'    `--' `.__,' \
\033[33;1m                                             +        +
\033[33;1m                                              \       /
\033[33;1m                                        ______( (_  / \______
\033[33;1m                                      ,'  ,-----'   +        \
\033[33;1m                                      `--{__________)        \/
sleep 1
clear
echo
echo
...
echo $ku"["$me"37"$ku"]"$i" Installation TxTool"
echo $ku"["$me"38"$ku"]"$i" Installation SQLScan"
echo $ku"["$me"39"$ku"]"$i" Installation Hash Buster"
echo $ku"["$me"40"$ku"]"$i" Installation Termux-A"
echo $ku"["$me"41"$ku"]"$i" Installation hunner"
echo $ku"["$me"42"$ku"]"$i" Installation SQLMap"
echo $ku"["$me"43"$ku"]"$i" Installation BinGoo"
echo $ku"["$me"44"$ku"]"$i" Installation LazySQLMap"
echo $ku"["$me"45"$ku"]"$i" Installation Diejobu"
echo $ku"["$me"46"$ku"]"$i" Installation Error Cyber Tools"
echo $ku"["$me"47"$ku"]"$i" Installation Tuyul BTC"
echo $ku"["$me"48"$ku"]"$i" Installation Metasploit Framework"
echo $ku"["$me"49"$ku"]"$i" Installation viSQL"
echo $ku"["$me"50"$ku"]"$i" Installation OwScan"
echo $ku"["$me"51"$ku"]"$i" installation Nmap"
echo $ku"["$me"52"$ku"]"$i" Installation AuxScan"
echo $ku"["$me"53"$ku"]"$i" Installation Hasher"
echo $ku"["$me"54"$ku"]"$i" Installation Phising Game"
echo $ku"["$me"55"$ku"]"$i" Installation Breacher"
echo $ku"["$me"56"$ku"]"$i" Installation Social Fish"
echo $ku"["$me"57"$ku"]"$i" Installation cupp"
echo $ku"["$me"58"$ku"]"$i" Installation Nuyul BTC vers.02"
echo $ku"["$me"59"$ku"]"$i" Installation Ko-Dork"
echo $ku"["$me"60"$ku"]"$i" Installation Check HP"
echo $ku"["$me"61"$ku"]"$i" Installation TheFat-Rat"
