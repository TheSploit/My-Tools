...
echo $ku"["$me"41"$ku"]"$i" Installation hunner Framework"
echo $ku"["$me"42"$ku"]"$i" Installation SQLMAP"
echo $ku"["$me"43"$ku"]"$i" Installation BinGoo"
echo $ku"["$me"44"$ku"]"$i" Installation termux-lazysqlmap"
echo $ku"["$me"45"$ku"]"$i" Installation diejoubu"
echo $ku"["$me"46"$ku"]"$i" Installation errorcybertool"
echo $ku"["$me"47"$ku"]"$i" Installation Nuyul BTC"
echo $ku"["$me"48"$ku"]"$i" Installation Metasploit"
...
echo $ku"["$me"55"$ku"]"$i" Installation Breacher multithreaded Admin Panel Finder"
