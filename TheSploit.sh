clear
	...
	echo $bi"["$me"4"$bi"]"$i" Malicious"
	echo $bi"["$me"5"$bi"]"$i" TrojanAtt"
	echo $me"["$me"6"$me"]"$i" Spam-Call(Perbaikan)"
	echo $bi"["$me"7"$bi"]"$i" Spam-Sms"
	echo $bi"["$me"8"$bi"]"$i" Virteks"
	echo $me"["$me"9"$me"]"$i" Phone Sploit"
	echo $bi"["$me"10"$bi"]"$i" CCTV"
	echo $bi"["$me"11"$bi"]"$i" Insta_Hack(Root-Only)"
	echo $me"["$me"12"$me"]"$i" Phising vers.01"
	echo $bi"["$me"13"$bi"]"$i" SPAM SMS BRUTAL TERBARU"
	echo $bi"["$me"14"$bi"]"$i" Trojan32-DDOS"
	echo $me"["$me"15"$me"]"$i" Botnet"
	echo $bi"["$me"16"$bi"]"$i" Xerxes"
	echo $bi"["$me"17"$bi"]"$i" Phising vers.02"
	echo $me"["$me"18"$me"]"$i" Phising vers.03"
	echo $bi"["$me"19"$bi"]"$i" Phising vers.04"
	echo $bi"["$me"20"$bi"]"$i" Termux Key Arrow"
	echo $me"["$me"21"$me"]"$i" Hack Twitter (Root-Only)"
	echo $bi"["$me"22"$bi"]"$i" Hack Gmail(Root-Only)"
	echo $bi"["$me"23"$bi"]"$i" Youtube AutoView (Root-Only)"
	echo $me"["$me"24"$me"]"$i" Spam Instagram"
	echo $bi"["$me"25"$bi"]"$i" pyRAT"
	echo $bi"["$me"26"$bi"]"$i" RedHawk"
	echo $me"["$me"27"$me"]"$i" SpamMasal"
	echo $bi"["$me"28"$bi"]"$i" Script Deface Creator"
	echo $bi"["$me"29"$bi"]"$i" BRUTEFORCE FB PHP"
	echo $me"["$me"30"$me"]"$i" BRUTEFORCE FB(Root-Only)"
	echo $bi"["$me"31"$bi"]"$i" Clone Yahoo FB"
	echo $bi"["$me"32"$bi"]"$i" Keperluan Efbeh"
	echo $bi"["$me"33"$bi"]"$i" Lazymux"
	echo $bi"["$me"34"$bi"]"$i" BlackHydra"
	echo $bi"["$me"35"$bi"]"$i" Admin Finder"
	echo $bi"["$me"36"$bi"]"$i" Deface Webdav"
	echo $bi"["$me"37"$bi"]"$i" Installation TxTool"
	echo $bi"["$me"38"$bi"]"$i" Installation SQLScan"
	echo $bi"["$me"39"$bi"]"$i" Installation Hash Buster"
	echo $bi"["$me"40"$bi"]"$i" Installation Termux-A"
	echo $bi"["$me"41"$bi"]"$i" Installation hunner"
	echo $bi"["$me"42"$bi"]"$i" Installation SQLMap"
	echo $bi"["$me"43"$bi"]"$i" Installation BinGoo"
	echo $bi"["$me"44"$bi"]"$i" Installation LazySQLMap"
	echo $bi"["$me"45"$bi"]"$i" Installation Diejobu"
	echo $bi"["$me"46"$bi"]"$i" Installation Error Cyber Tools"
	echo $bi"["$me"47"$bi"]"$i" Installation Tuyul BTC"
	echo $bi"["$me"48"$bi"]"$i" Installation Metasploit Framework"
	echo $bi"["$me"49"$bi"]"$i" Installation viSQL"
	echo $bi"["$me"50"$bi"]"$i" Installation OwScan"
	echo $bi"["$me"51"$bi"]"$i" installation Nmap"
	echo $bi"["$me"52"$bi"]"$i" Installation AuxScan"
	echo $bi"["$me"53"$bi"]"$i" Installation Hasher"
	echo $bi"["$me"54"$bi"]"$i" Installation Phising Game"
	echo $bi"["$me"55"$bi"]"$i" Installation Breacher"
	echo $bi"["$me"56"$bi"]"$i" Installation Social Fish"
	echo $bi"["$me"57"$bi"]"$i" Installation cupp"
	echo $bi"["$me"58"$bi"]"$i" Installation Nuyul BTC vers.02"
	echo $bi"["$me"59"$bi"]"$i" Installation Ko-Dork"
	echo $bi"["$me"60"$bi"]"$i" Installation Check HP"
	echo $bi"["$me"61"$bi"]"$i" Installation TheFat-Rat"
	echo $bi"["$me"62"$bi"]"$i" Installation CMSmap"
	echo $bi"["$me"63"$bi"]"$i" Installation ubuntu"
	echo $bi"["$me"64"$bi"]"$i" Installation Ngrok"
	echo $bi"["$me"65"$bi"]"$i" Installation Lokomedia Eksploiters"
	echo $bi"["$me"66"$bi"]"$i" Installation NetHunter"
	echo $bi"["$me"67"$bi"]"$i" Installation Jomscan"
	echo $bi"["$me"68"$bi"]"$i" Installation Vuln Scanner"
	echo $bi"["$me"69"$ku"]"$i" Linux Fedora"
