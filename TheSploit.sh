clear
	...
	echo
	echo $me"[==============="$pu"===============]        "$me"────────"
	echo $bi"["$pu"1"$bi"]"$i" Dark FB  		       ""$pu"=====>     "$i"|"$bi"    |"$cy" Active"$bi" |"
	echo $me"[==============="$pu"===============]"
	echo $bi"["$pu"2"$bi"]"$i" Hack-Cam_Phone	       ""$pu"=====>     "$i"|"$bi"    |"$cy" Active"$bi" |"
	echo $me"[==============="$pu"===============]"
	echo $me"["$pu"3"$me"]"$i" Check IP                   "$pu"=====>     ""$i"|"$bi"    |"$cy" Active"$bi" |"
	echo $me"[==============="$pu"===============]"
	echo $bi"["$pu"4"$bi"]"$i" Malicious                  "$pu"=====>     ""$i"|"$bi"    |"$cy" Active"$bi" |"
	echo $me"[==============="$pu"===============]"
	echo $bi"["$pu"5"$bi"]"$i" TrojanAtt                  "$pu"=====>     ""$i"|"$bi"    |"$cy" Active"$bi" |"
	echo $me"[==============="$pu"===============]"
